...
export const GROUPS: Group[] = [
  {
    ...
    intro:
      "Most frustration with an HOA isn't about big things. It's the unanswered email, the confusing bill, the sense that no one is minding the store. These are solvable, not with slogans but with better systems and the staffing to run them.",
    goals: [
      {
        ...
        why: [
          "Slow service is usually a capacity problem, not an attitude problem: a small team is buried in routine requests, so the important ones wait. The fix is to take the routine work off their plate. When common requests (a gate code, a balance, a copy of the rules, a status update) are handled automatically and instantly, the human team is freed to spend its time on the things that need judgment. Responsiveness stops depending on whether someone happens to have a free hour.",
        ],
        toward:
      ...
      },
      {
        ...
        why: [
          "An association's finances are its members' finances. Budgets, reserves, and spending can be presented in plain language rather than buried in a quarterly PDF. Openness isn't a feature to add. It's the default we intend to start from, because trust in an association begins with books its members can read.",
        ],
  ...
  {
    n: "Group 2",
    head: "Fewer surprises, lower bills",
    intro:
  ...
  },
  {
    ...
    goals: [
      ...
      },
      {
        ...
        why: [
          "This is the least glamorous promise and, in a way, the most important. Much of the frustration with community management is simply technology that doesn't work reliably. There's no innovation required to fix it, just the discipline to build things that function and the ownership model to keep investing in them over time. Because we intend to keep these companies, we have every reason to build technology that lasts rather than technology that demos well.",
        ],
