...
const USUAL: Row[] = [
  {
    ...
    line: "It lands in a shared inbox behind dozens of others. You wait, then email again.",
  },
  {
    icon: "doc-alert",
    time: "Statement day",
  ...
  },
  {
    ...
    line: "Requests, decisions and money all feel a little opaque and a little slow.",
  },
];
...
const OURS: Row[] = [
  {
    ...
    line: "You get the answer right away, day or night, and a person for anything that needs one.",
  },
  {
    icon: "doc-check",
    time: "Any time",
  ...
  },
  {
    ...
    line: "A small alert while it's still a small repair. The flood, the claim and the disruption never happen.",
  },
  {
    icon: "list-status",
    time: "Always",
    title: "You can see where things stand",
    line: "Requests, decisions and the books are open and current.",
  },
];
