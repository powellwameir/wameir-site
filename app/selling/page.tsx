...
export const metadata: Metadata = {
  ...
  description:
    "Selling your management company is a big decision. Wameir buys HOA management companies with its own capital, runs them itself, and plans to keep them.",
};
    ...
    <>
      <header className="page-header">
        ...
        <div className="wrap">
          ...
          <p className="lede">
            A private conversation with operators who plan to keep what they buy.
          </p>
        </div>
      </header>
      ...
      <PullQuote bg="cream" size="md" after={<p>That&apos;s why we started Wameir.</p>}>
        ...
        It&apos;s your employees, your clients, your reputation, and everything
        you&apos;ve spent years{" "}
          ...
          <div className="split">
            ...
            <div className="split__body">
              <p>
                ...
                to own them for good. Our goal isn&apos;t to change what makes your
                company successful. It&apos;s to give it the resources to become{" "}
                <strong>even stronger</strong>.
              </p>
              <p>
                Whether you&apos;re ready to retire, looking for a partner, or simply
                exploring your options, we&apos;d welcome a conversation.
              </p>
      ...
      <ContactSection
        ...
        body="If you're thinking about selling, even a year or two out, a first conversation costs nothing and stays between us."
        heading={
          <>
